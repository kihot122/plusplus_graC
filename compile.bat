...
g++ ./obj/window.obj ./obj/cell/cell.obj ./obj/virtual/snake.obj ./obj/client.obj -L./lib -o ./bin/client.exe -lsfml-graphics -lsfml-window -lsfml-system

g++ ./obj/cell/cell.obj ./obj/virtual/snake.obj ./obj/server.obj -L./lib -o ./bin/server.exe 